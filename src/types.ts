...
export const agentActionSchema = z.discriminatedUnion('type', [
  ...
  z.object({ type: z.literal('disassembleFactories') }),
  z.object({ type: z.literal('disassembleHarvesters') }),
  z.object({ type: z.literal('disassembleWireDrones') }),
  z.object({ type: z.literal('disassembleFarms') }),
  z.object({ type: z.literal('disassembleBatteries') }),
